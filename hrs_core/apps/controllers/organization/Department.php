...
class Department extends MY_Controller
{
    ...
    public function save()
    {
        ...
        $save = $this->Department_m->save($dept_id, $dept_name, $xianbie, $floor, $rengongleibie, $gongziguishufeiyong, $has_overtime, $noon_break_start, $noon_break_end, $night_break_start, $night_break_end, $is_enable, $this->session->username);
