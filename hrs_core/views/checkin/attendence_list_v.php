                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="center"><?=$sorted_depts[$staff[$row['machine_id']]['dept_id']]['dept_name']?></td>
                                    <td class="center"><?=$staff[$row['machine_id']]['name']?></td>
                                    <td class="center"><?=$staff[$row['machine_id']]['staff_code']?></td>
...
$("#expdata").on("click", function(){
    $('#form_search').attr("action", "/checkin/attendence/expcheckin");
    $('#form_search').submit();
})
</script>
