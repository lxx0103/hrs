...
$("#expdata").on("click", function(){
    $('#form_search').attr("action", "/checkin/attendence/expdata");
    $('#form_search').submit();
})

$("#search_btn").on("click", function(){
    $('#form_search').attr("action", "/checkin/attendence/staff");
    $('#form_search').submit();
})

$("#history").on("click", function(){
    $('#form_search').attr("action", "/checkin/attendence/savehistory");
    $('#form_search').submit();
})


$("#expdetail").on("click", function(){
    $('#form_search').attr("action", "/checkin/attendence/expalldetail");
    $('#form_search').submit();
})
</script>
